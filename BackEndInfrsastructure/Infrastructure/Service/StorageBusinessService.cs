...
{
    public abstract class StorageBusinessService<Model, PrimaryKeyType> : BaseBusinessService<Model>
     ...
     where PrimaryKeyType : struct
    {
        ...
        /// </param>
        public StorageBusinessService(ILogger<Model> logger, int logBaseID) : base(logger)
        {
